...
json merge_json_unit_list(   const struct savegame *sg, json j )
{
    ...
    for (int i = 0; i < sg->count.unit; ++i) {
        ...
        j["unit_list"][i]["y"]["value"] = sg->unit[i].y;
...
json merge_json_tribe_list(   const struct savegame *sg, json j )
{
    ...
    for (int i = 0; i < sg->count.tribe; ++i) {
        ...
        j["tribe_list"][i]["y"]["value"] = sg->tribe[i].y;
        j["tribe_list"][i]["nation"]["value"] = sg->tribe[i].nation;
        j["tribe_list"][i]["mission"]["value"] = sg->tribe[i].mission;
        j["tribe_list"][i]["population"]["value"] = sg->tribe[i].population;
        j["tribe_list"][i]["unk1"]["value"] = sg->tribe[i].unk1;
        j["tribe_list"][i]["unk2"]["value"] = sg->tribe[i].unk2;
        j["tribe_list"][i]["x"]["value"] = sg->tribe[i].x;
        j["tribe_list"][i]["panic"]["value"] = sg->tribe[i].panic;
        j["tribe_list"][i]["state"]["learned"]["value"] = uint16_t( sg->tribe[i].state.learned );
        j["tribe_list"][i]["state"]["scouted"]["value"] = uint16_t( sg->tribe[i].state.scouted );
        j["tribe_list"][i]["state"]["unk6"]["value"] = uint16_t( sg->tribe[i].state.unk6 );
        j["tribe_list"][i]["state"]["unk5"]["value"] = uint16_t( sg->tribe[i].state.unk5 );
        j["tribe_list"][i]["state"]["artillery"]["value"] = uint16_t( sg->tribe[i].state.artillery );
        j["tribe_list"][i]["state"]["capital"]["value"] = uint16_t( sg->tribe[i].state.capital );
        j["tribe_list"][i]["state"]["unk7"]["value"] = uint16_t( sg->tribe[i].state.unk7 );
        j["tribe_list"][i]["state"]["unk8"]["value"] = uint16_t( sg->tribe[i].state.unk8 );
        j["tribe_list"][i]["population_loss_in_current_turn"]["value"] = sg->tribe[i].population_loss_in_current_turn;
    }
    return j;
}
